...
export async function POST(req: NextRequest) {
  try {
    ...
    const { line_1, line_2, line_3, author, place_name, place_city, place_lat, place_lng, google_place_id, photo_url } = body;
